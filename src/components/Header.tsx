      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/templates" className="text-text-medical hover:text-primary transition-colors">
              Templates
            </Link>
            <a href="#testimonials" className="text-text-medical hover:text-primary transition-colors">
              Testimonials
            </a>
            <Link to="/pricing" className="text-text-medical hover:text-primary transition-colors">
              Pricing
            </Link>
          </nav>
